...
const contactInfo = [
  {
    icon: MapPin,
    title: 'Address',
    details: ['Oliyide street, Jankara Ijaiye, Lagos, Nigeria'],
    color: 'text-blue-600',
    bgColor: 'bg-blue-100',
  },
  {
  ...
  },
  {
    icon: Mail,
    title: 'Email',
    details: ['info@parentaltouch.edu'],
                  ...
                  <div className="aspect-video bg-gray-200 relative">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-400">Oliyide street, Jankara Ijaiye, Lagos, Nigeria</p>
                      </div>
                    </div>
                  </div>
                </Card>
