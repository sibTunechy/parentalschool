        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <span className="text-xl font-bold">Parental Touch Schools</span>
            </motion.div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span>Parental Touch Schools, Oliyide street Jankara Ijaiye</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span>info@parentaltouchschools.edu</span>
              </div>
            </div>
          </div>
